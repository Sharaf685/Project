...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to DIU BloodBank</h1>
...
{ ?>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top img-fluid" src="images/n.png" alt="" ></a>
...
<li>AB positive or AB negative.</li>
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="images/bloodb.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
